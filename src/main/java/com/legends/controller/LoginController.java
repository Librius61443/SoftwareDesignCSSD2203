...
public class LoginController {
    ...
    class LoginListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (authenticatedUser != null) {
                Point loginLocation = loginView.getLocation();
                loginView.dispose();

                com.legends.view.HomeView homeView = new com.legends.view.HomeView(authenticatedUser.getUsername());
                homeView.setLocation(loginLocation);
                new com.legends.controller.HomeController(homeView, authenticatedUser, AppServices.matchmakingService());
    ...
    class RegisterListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (isCreated) {
                loginView.displaySuccessMessage("Account created! You can now log in.");
            } else {
                loginView.displayErrorMessage("Failed to create account.");
            }
        }
    }
}
